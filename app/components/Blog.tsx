...
export default function Blog() {
  return (
    <section id="blog" className="py-16 bg-white container mx-auto px-6">
      <h2 className="bg-[#7E8038] font-space-grotesk text-black text-4xl font-bold rounded-lg px-7 py-2 uppercase mb-12 tracking-wide w-[115px] h-[51px] flex items-center justify-center ml-[8.2rem]">
        BLOG
      </h2>

      <div
        className="grid grid-cols-1 md:grid-cols-3 gap-6"
        style={{ paddingLeft: "8.2rem" }}
      >
